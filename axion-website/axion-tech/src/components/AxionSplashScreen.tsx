...
export function AxionSplashScreen({
  ...
  const block1Variants = {
    ...
    animate: {
      ...
      transition: {
        ...
        x: { duration: 0.65, delay: 0.6, ease: [0.34, 1.3, 0.64, 1] },
        y: { duration: 0.65, delay: 0.6, ease: [0.34, 1.3, 0.64, 1] },
      },
    },
  };
  ...
  const technologiesTextVariants = {
  ...
  const containerVariants = {
    ...
    exit: {
      scale: 0.35,
      x: -window.innerWidth * 0.35, // directionally morphs toward top-left navbar
