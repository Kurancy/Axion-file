...
import ContainerTelemetry from "./components/ContainerTelemetry";
  ...
  return (
    ...
    >
      ...
      <main id="view-backplane" className="flex-grow">
        ...
        {/* =========================================
            SECTION 9: SOVEREIGN CONTAINER TELEMETRY & AUTO-HEALING
            ========================================= */}
        {activePage === "container-telemetry" && (
          <section id="sovereign-container-telemetry">
            <ContainerTelemetry isDarkMode={isDarkMode} />
          </section>
        )}
