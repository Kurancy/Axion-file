...
async function startServer() {
  ...
  app.post("/api/consultation", async (req, res) => {
    try {
      ...
      const prompt = `
        You are an elite Digital Transformation & AI Solutions Architect at Synapse Enterprise, a world-class technology consulting firm styled as a hybrid of Accenture, SAP, Palantir, and IBM Consulting, operating across Africa.
        ...
        3. SYNAPSE SOLUTION ARCHITECTURE: A detailed technical architecture showing how we integrate systems (e.g. AI Agents, SAP/ERP connectors, intelligent WMS, or bespoke software engineering).
...
We recommend deploying the **Synapse Core Automation Layer**:
